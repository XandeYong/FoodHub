...
@Database(entities = [Account::class, News::class, Category::class, DonationForm::class, RequestForm::class, AnalysisReport::class, LocationReport::class], version = 6, exportSchema = false)
